 ...
 */
public abstract class statusActivity extends AbstractSuperActivity {
...
//            getWindow().addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION);
            ...
            setStatusBar();
//        setstatusColor(this, getResources().getColor(R.color.red_deep));//和toolbar一个颜色
    }
