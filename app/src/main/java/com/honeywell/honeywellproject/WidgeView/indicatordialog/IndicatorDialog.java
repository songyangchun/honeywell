...
import static com.honeywell.honeywellproject.WidgeView.indicatordialog.IndicatorBuilder.BOTTOM;
import static com.honeywell.honeywellproject.WidgeView.indicatordialog.IndicatorBuilder.LEFT;
import static com.honeywell.honeywellproject.WidgeView.indicatordialog.IndicatorBuilder.TOP;
import static com.honeywell.honeywellproject.WidgeView.indicatordialog.IndicatorBuilder.RIGHT;
...
public class IndicatorDialog {
    ...
    private void addRecyclerView2Layout() {
        childLayout = (LinearLayout) LayoutInflater.from(mContext).inflate(R.layout.dialog_layout_indicator, rootLayout, true);
