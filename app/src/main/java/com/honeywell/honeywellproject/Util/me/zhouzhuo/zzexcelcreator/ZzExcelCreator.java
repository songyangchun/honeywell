...
public class ZzExcelCreator implements ExcelManager {
    ...
    @Override
    public ZzExcelCreator createSheet(String name,int i) {
        checkNullFirst();
        writableSheet = writableWorkbook.createSheet(name, i);
        return this;
    }
    ...
    @Override
    public void closeSheet() throws IOException, WriteException {
        checkNullSecond();
        writableSheet = null;
    }
    @Override
