...
package com.honeywell.honeywellproject.Util.me.zhouzhuo.zzexcelcreator;
...
public interface ExcelManager {
     ...
     */
    com.honeywell.honeywellproject.Util.me.zhouzhuo.zzexcelcreator.ZzExcelCreator createExcel(String pathDir, String name) throws IOException;
     ...
     * @return ZzExcelCreator
     */
    ZzExcelCreator createSheet(String name,int position);
    ...
    void closeSheet() throws IOException, WriteException;
}
