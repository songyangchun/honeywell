...
public class MailInfo {
	...
	private File attachFileNames;// 邮件附件的文件名
	private String[]  CCs;// 抄送人数组，多个地址
	/**
	 * 获得邮件会话属性
	 */
...
//		p.put("mail.smtp.socketFactory.class", "javax.net.ssl.SSLSocketFactory");// ssl方式
		return p;
	}
	...
	public void setAttachFileNames(File fileNames) {
